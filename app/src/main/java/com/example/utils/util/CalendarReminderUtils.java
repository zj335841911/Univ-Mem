...
public class CalendarReminderUtils {
    ...
    private static final String CALENDARS_NAME = "UniversityMemoryCoursesTimetable";
    private static final String CALENDARS_ACCOUNT_NAME = "UniversityMemory@qq.com";
    private static final String CALENDARS_ACCOUNT_TYPE = "com.UniversityMemory.timetable";
    //    private static final String CALENDARS_ACCOUNT_TYPE = CalendarContract.ACCOUNT_TYPE_LOCAL;
    private static final String CALENDARS_DISPLAY_NAME = "大学记课程表";

    public static final String DESCRIPTION = "大学记课程表自动创建";
