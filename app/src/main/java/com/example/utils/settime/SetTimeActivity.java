package com.example.utils.settime;
...
import com.example.univ_mem.course.main.MainActivity;
...
public class SetTimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_set_time);
        setActionBar();
...
//        Log.d("settime", "通知更新");
    ...
    private void showTimeSelectDialog(final TextView textView, final int index) {
        ...
        if (!times[index].getEnd().isEmpty()) {
            ...
            mOptionsPv.setSelectOptions(option, option + 1);
        } else {
