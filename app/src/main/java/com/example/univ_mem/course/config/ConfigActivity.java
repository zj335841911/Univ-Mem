package com.example.univ_mem.course.config;
...
import com.example.adapter.BgBtnAdapter;
...
//                Toast.makeText(ConfigActivity.this,"已删除所有课程日程",Toast.LENGTH_SHORT);
//            } else {
...
//        });
//
//        Button createBtn =findViewById(R.id.btn_create_calendar_event);
//        createBtn.setOnClickListener(view ->{
//            if(ActivityCompat.checkSelfPermission(this, PERMISSIONS[0]) == PackageManager.PERMISSION_GRANTED) {
//                Toast.makeText(ConfigActivity.this,"已添加所有课程日程",Toast.LENGTH_SHORT);
//            }else{
//                ActivityCompat.requestPermissions(this, PERMISSIONS, REQUEST_WRITE_CALENDAR);
//
//            }
