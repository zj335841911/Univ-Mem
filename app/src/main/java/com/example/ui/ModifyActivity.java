...
public class ModifyActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        androidx.appcompat.widget.Toolbar toolbar = (androidx.appcompat.widget.Toolbar) findViewById(R.id.modifyActivity_toolbar);
        setSupportActionBar(toolbar);//如不需用到ActionBar的某些功能，则省略这句
        ActionBar actionBar = getSupportActionBar();
        if (actionBar != null) {
            actionBar.setDisplayHomeAsUpEnabled(true);
            actionBar.setHomeAsUpIndicator(R.drawable.univ_mem_icon_back);
        }
    }
