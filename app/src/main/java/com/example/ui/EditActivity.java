...
//        androidx.appcompat.widget.Toolbar toolbar = (androidx.appcompat.widget.Toolbar) findViewById(R.id.modifyActivity_toolbar);knifeText.setSelection(knifeText.getEditableText().length());
